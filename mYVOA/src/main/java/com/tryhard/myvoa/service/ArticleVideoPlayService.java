package com.tryhard.myvoa.service;
...
public class ArticleVideoPlayService extends Service implements
    ...
    public static final String EXTRA_STRING = "mp3UriString";
    ...
    public IBinder onBind(Intent intent) {
        ...
        String mp3UriString = (String)extra.get(EXTRA_STRING);
        if (!mp3UriString.equals(ArticleContentActivity.NO_MP3)) {
